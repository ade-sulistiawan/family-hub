...
namespace FamilyHub.Api.Data.Migrations
{
    ...
    [Migration("20260826035059_AddFirstAidTypeAndLowStockNotifications")]
    partial class AddFirstAidTypeAndLowStockNotifications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyHub.Api.Notifications.LowStockNotificationDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ItemId", "BrowserPushSubscriptionId")
                        .IsUnique();

                    b.ToTable("LowStockNotificationDeliveries");
                });
            ...
            modelBuilder.Entity("FamilyHub.Api.Settings.PaperlessSettings", b =>
                {
                    b.Property<Guid>("HouseholdId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FamilyHub.Api.Settings.PaperlessSettings", b =>
                {
                    b.HasOne("FamilyHub.Api.Households.Household", null)
                        .WithOne()
                        .HasForeignKey("FamilyHub.Api.Settings.PaperlessSettings", "HouseholdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
